...
//              Compra de ingressos
                ...
                while(adicionando_ingresssos){
                    ...
                    for(Ingresso Ingresso: sessoes){
                        System.out.println(escolha_filme + ") " + Ingresso.getHorario() + " em sala " + Ingresso.getSala() + ". Ingresso " + Ingresso.getTipo_ingresso() + " no unitário de R$" + Ingresso.getPreco() + ",00."  );
                        escolha_filme++;
                    }
